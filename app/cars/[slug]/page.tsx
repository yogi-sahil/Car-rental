...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  if (!car) return {};
  return { title: `${car.name} Self Drive Rental in Jaipur`, description: `${car.summary} ₹${car.price.toLocaleString("en-IN")} for 24 hours with 300 km included. View features, trip fit and booking details.`, alternates: { canonical: `/cars/${car.slug}` }, openGraph: { images: [car.image] } };
}
