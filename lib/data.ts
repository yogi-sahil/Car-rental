...
export const cars: Car[] = [
  ...
  { ...sharedPlan, slug: "kia-sonet", name: "Kia Sonet", category: "Feature-rich compact SUV", image: "/images/cars/kia-sonet.webp", price: 2999, seats: 5, transmission: "Automatic", fuel: "Diesel", luggage: 3, mileage: "Up to 18 km/l", summary: "A feature-rich compact SUV for premium city comfort and relaxed highway cruising.", bestFor: ["Premium city use", "Small families", "Jaipur–Pushkar drives"], features: ["Connected cabin", ...sharedFeatures] },
  { ...sharedPlan, slug: "hyundai-venue", name: "Hyundai Venue", category: "Urban compact SUV", image: "/images/cars/hyundai-venue.webp", price: 2999, seats: 5, transmission: "Manual", fuel: "Petrol", luggage: 2, mileage: "Up to 18 km/l", summary: "A compact, comfortable SUV made for Jaipur streets and easy weekend highways.", bestFor: ["Urban travel", "Couples", "Short Rajasthan drives"], features: ["Compact SUV convenience", ...sharedFeatures] },
];
